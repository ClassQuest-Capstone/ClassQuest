    ...
    <div className="font-poppins min-h-screen bg-gray-50">
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="max-w-md w-full space-y-8 p-6">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg transition-all hover:-translate-y-1 hover:shadow-xl">
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Access your quests and rewards
                    </p>
                  </div>
                  <div>
                    <Link
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Dont have an account? Contact your teacher or administrator
            </p>
          </div>
        </div>
      </div>
