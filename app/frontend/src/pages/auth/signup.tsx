  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (userType === "student") {
      ...
      try {
        ...
        console.log("[signup] Student signup complete, navigating to /studentlogin");
        setSuccess("Student account created! Joining class...");
        setTimeout(() => navigate("/studentlogin", { replace: true }), 300);
      } catch (err: any) {
              ...
              <form onSubmit={handleConfirmation} className="mt-8 space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2 border border-gray-300 text-gray-900 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
