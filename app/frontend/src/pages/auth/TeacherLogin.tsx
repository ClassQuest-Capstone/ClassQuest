  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isSignedIn) {
        ...
        setError(
          "Additional verification required. Please check your email or follow the prompts."
        );
      }
    } catch (err: any) {
      console.error("Login error:", err);

      // Friendly Amplify errors
      if (err?.name === "UserNotConfirmedException") {
        ...
        setError(
          "You were already signed in. Please click Sign In again (or refresh), and it should work."
        );
      } else {
            ...
            <div className="text-center mb-6">
              ...
              <form onSubmit={handleLogin} className="mt-8 space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-blue-600 hover:text-blue-500 text-right ml-auto text-sm"
                  >
                    Forgot password?
                  </Link>
                </div>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-600">First time using ClassQuest?</p>
